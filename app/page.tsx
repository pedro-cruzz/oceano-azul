...
// ==============================================================================
// 2. VIEW: IJA DRONES (O SOFTWARE/SaaS) - COM DASHBOARD DETALHADO + HERO ANIMADO
// ==============================================================================
...
function IjaDronesView({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div className="flex-1 relative w-full flex justify-center items-center">
                    <Reveal delay={0.4} className="relative w-full max-w-lg aspect-square">
                        ...
                        {/* DRONE COM ANIMAÇÃO DE FLUTUAR */}
                        <motion.div
                            animate={{ y: [0, -25, 0] }} // Movimento Sobe e Desce
                            transition={{ 
                                duration: 4, 
                                repeat: Infinity, 
                                ease: "easeInOut" 
                        ...
                        >
                            {/* SUBSTITUA O SRC PELA SUA IMAGEM DE DRONE RECORTADA (PNG) */}
                             ...
                             {/* Elemento flutuante extra para dar profundidade */}
                             <motion.div 
                                animate={{ y: [0, 15, 0] }}
                             ...
                             >
                                 ...
                                 <div>
                                     ...
                                     <div className="text-sm font-bold text-slate-900">Operação Ativa</div>
                                 </div>
                             </motion.div>
                        </motion.div>
                    </Reveal>
      ...
      <section className="py-10 bg-slate-50">
          <Container>
              <div className="text-center max-w-3xl mx-auto mb-12">
                  <Reveal>
                      <h2 className="text-3xl font-bold text-slate-900 mb-4">Poder e Controle na Palma da Mão</h2>
                  </Reveal>
                  <Reveal delay={0.1}>
                      <p className="text-slate-600">
                          Nossa interface foi desenhada para facilitar a vida do gestor. 
                          Acompanhe cada detalhe da operação em tempo real.
                      </p>
                  </Reveal>
              </div>
          </Container>
        ...
        <AnimatedImageFrame className="shadow-2xl border border-slate-200 bg-white">
            ...
            <div className="flex h-[700px] bg-slate-50/30 text-left">
                ...
                <div className="w-16 md:w-56 bg-white border-r border-slate-200 p-4 flex flex-col justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100"><div className="w-8 h-8 rounded-full bg-sky-100 border border-sky-200 flex items-center justify-center text-xs font-bold text-sky-700">PH</div><div className="text-xs"><div className="font-bold text-slate-700">Admin 1</div><div className="text-slate-400">Admin</div></div></div>
                </div>
                ...
                <div className="flex-1 p-6 overflow-y-auto bg-slate-50/50 relative">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex gap-2">
                             {activeTab === 'pilotos' ? (
                                ...
                                <div className="h-8 px-3 bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-600 shadow-sm flex items-center gap-2 cursor-pointer hover:bg-slate-50"><Filter size={12}/> Filtros</div>
                            )}
                    ...
                    <div className="flex-1 min-h-0 relative">
                        {/* 1. DASHBOARD COMPLETO - PAINEL DE GESTÃO (ATUALIZADO) */}
                        {activeTab === 'dashboard' && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col gap-4 h-full">
                                
                                {/* Header Interno */}
                                <div className="flex justify-between items-center mb-1">
                                    <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2"><Shield size={20} className="text-slate-700"/> Painel de Gestão</h2>
                                    <button className="h-8 px-4 rounded-lg bg-sky-500 text-white text-xs font-bold flex items-center gap-1 hover:bg-sky-600 shadow-sm transition-colors"><FileDown size={14}/> Exportar Excel</button>
                                </div>
                                ...
                                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 flex flex-col md:flex-row gap-6">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="space-y-1 text-xs text-slate-600">
                                            ...
                                            <div className="flex items-center gap-2"><MapPin size={14} className="text-sky-500"/> Avenida Paulista, 09 - Bela Vista</div>
                                ...
                                {/* Card Secundário (Visual) */}
                                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 opacity-50">
                                     <h3 className="text-base font-bold text-slate-400">UVIS Teste QA 2</h3>
                                </div>
      ...
      {/* Grid de Recursos (Bento Grid) - RESTAURADO */}
      <Section id="recursos">
        <Container>
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
                <div className="col-span-1 md:col-span-1">
                    <div className="flex items-center gap-2 mb-6">
                        <div className="w-10 h-10 bg-sky-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">IJ</div>
                        <span className="text-2xl font-bold text-white tracking-tight">IJA<span className="text-sky-500">System</span></span>
                    </div>
                    <p className="text-sm text-slate-400 mb-6">Soluções tecnológicas avançadas para o mercado de drones e aviação agrícola.</p>
                    <div className="flex gap-4">
                        <a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-sky-600 transition-colors"><Facebook size={18}/></a>
                        <a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-sky-600 transition-colors"><Instagram size={18}/></a>
                        <a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-sky-600 transition-colors"><Linkedin size={18}/></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Funcionalidades</a></li>
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Planos e Preços</a></li>
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Para Pilotos</a></li>
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Para Empresas</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Sobre Nós</a></li>
                        ...
                        <li><button onClick={onBack} className="hover:text-sky-400 transition-colors flex items-center gap-1">Voltar para AgroAzul <ArrowRight size={12}/></button></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li><a href="#" className="hover:text-sky-400 transition-colors">Documentação API</a></li>
      ...
      /* Footer IJA - IGUAL AGROAZUL (AZUL ESCURO) */
...
// ==============================================================================
// 3. VIEW: AGRO AZUL (HOME INSTITUCIONAL) - RESTAURADA COM ANIMAÇÕES
// ==============================================================================
...
function AgroAzulView({ onNavigateToSystem }: { onNavigateToSystem: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} transition={{ duration: 0.6 }} className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-gray-100 h-20">
        <Container>
            <div className="flex items-center justify-between h-20">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <button className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold text-sm shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition-all">Solicitar Orçamento</button>
                </div>
         ...
         <Container>
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                ...
                <div className="flex-1 w-full relative">
                    <Reveal delay={0.4}>
                        <AnimatedImageFrame className="aspect-[16/10] shadow-2xl bg-slate-100">
                            <div className="absolute inset-0 bg-slate-200 flex items-center justify-center">
                                <div className="text-center text-slate-400">
                                    <Cloud size={64} className="mx-auto mb-2 opacity-50"/>
                                    <span>Imagem do Drone em Ação</span>
                                </div>
                            </div>
                            {/* Card Flutuante */}
                            <motion.div 
                                ...
                                className="absolute bottom-6 left-6 bg-white p-4 rounded-xl shadow-lg border border-slate-100 flex items-center gap-4 max-w-xs"
                            >
                                <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-blue-600"><Zap size={24}/></div>
                                <div>
                                    <div className="font-bold text-slate-900 text-sm">Tecnologia Avançada</div>
                                    <div className="text-xs text-slate-500">Drones de Última Geração</div>
                                </div>
                            </motion.div>
                        </AnimatedImageFrame>
                    </Reveal>
      ...
      <section id="servicos" className="py-20 bg-slate-50">
         <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
                <Reveal><span className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-600 text-xs font-bold mb-4 uppercase">Nossos Serviços</span></Reveal>
                <Reveal delay={0.1}><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Soluções Profissionais para Cada Necessidade</h2></Reveal>
                <Reveal delay={0.2}><p className="text-slate-500">Atendemos produtores rurais e órgãos públicos com serviços especializados.</p></Reveal>
            </div>
      ...
      <section id="beneficios" className="py-20 bg-white">
         <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
                <Reveal><span className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-600 text-xs font-bold mb-4 uppercase">Vantagens</span></Reveal>
                <Reveal delay={0.1}><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Por Que Escolher a <span className="text-blue-600">Agro Azul?</span></h2></Reveal>
                <Reveal delay={0.2}><p className="text-slate-500">Benefícios comprovados que fazem a diferença no seu negócio.</p></Reveal>
            </div>
                ...
                {[
                    ...
                    <Reveal key={i} delay={i * 0.05} className="h-full">
                        <div className="h-full p-6 rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-md transition-shadow">
                            <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 mb-4"><item.icon size={20}/></div>
      ...
      <section className="py-20 bg-blue-600 text-white relative overflow-hidden">
          ...
          <Container className="relative z-10 text-center">
              <Reveal><h2 className="text-3xl md:text-4xl font-bold mb-6">Equipe Profissional e Certificada</h2></Reveal>
              <Reveal delay={0.1}><p className="text-blue-100 text-lg max-w-2xl mx-auto mb-10">Conte com especialistas experientes e equipamentos de última geração para garantir os melhores resultados.</p></Reveal>
              <Reveal delay={0.2}>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <button className="px-8 py-3.5 bg-white text-blue-700 rounded-full font-bold hover:bg-blue-50 transition-colors">Agendar Visita Técnica</button>
                      <button className="px-8 py-3.5 border-2 border-blue-400 text-white rounded-full font-bold hover:bg-blue-500 hover:border-blue-500 transition-colors">Falar com Especialista</button>
                  </div>
              </Reveal>
          </Container>
      </section>
      ...
      <section id="contato" className="py-20 bg-white">
          <Container>
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                  <div>
                      <Reveal><div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold mb-4 border border-blue-100"><Mail size={12}/> Entre em Contato</div></Reveal>
                      <Reveal delay={0.1}><h2 className="text-4xl font-bold text-slate-900 mb-4">Solicite um Orçamento <span className="text-blue-600">Sem Compromisso</span></h2></Reveal>
                      <Reveal delay={0.2}><p className="text-slate-500 mb-8">Nossa equipe está pronta para atender você e apresentar a melhor solução para suas necessidades.</p></Reveal>
                      <div className="space-y-6">
                          <Reveal delay={0.3}><div className="flex items-start gap-4"><div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 flex-shrink-0"><Mail size={20}/></div><div><h4 className="font-bold text-slate-900">Email</h4><p className="text-slate-500 text-sm">contato@agroazul.com.br</p></div></div></Reveal>
                          <Reveal delay={0.4}><div className="flex items-start gap-4"><div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 flex-shrink-0"><Phone size={20}/></div><div><h4 className="font-bold text-slate-900">WhatsApp</h4><p className="text-slate-500 text-sm">+55 (11) 98765-4321</p></div></div></Reveal>
                          <Reveal delay={0.5}><div className="flex items-start gap-4"><div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 flex-shrink-0"><MapPin size={20}/></div><div><h4 className="font-bold text-slate-900">Localização</h4><p className="text-slate-500 text-sm">São Paulo, Brasil</p></div></div></Reveal>
                      </div>
                  </div>
                  <Reveal delay={0.2} className="bg-slate-50 rounded-3xl p-8 border border-slate-100 shadow-sm w-full">
                      <form className="space-y-4">
                          <div><label className="block text-xs font-bold text-slate-700 mb-1">Nome Completo</label><input type="text" placeholder="Seu nome" className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"/></div>
                          <div><label className="block text-xs font-bold text-slate-700 mb-1">Email</label><input type="email" placeholder="seu@email.com" className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"/></div>
                          <div><label className="block text-xs font-bold text-slate-700 mb-1">Telefone</label><input type="tel" placeholder="(00) 00000-0000" className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"/></div>
                          <div><label className="block text-xs font-bold text-slate-700 mb-1">Serviço de Interesse</label><select className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-slate-600"><option>Selecione uma opção</option><option>Pulverização Agrícola</option><option>Controle de Dengue</option><option>Mapeamento Aéreo</option></select></div>
                          <div><label className="block text-xs font-bold text-slate-700 mb-1">Mensagem</label><textarea rows={4} placeholder="Conte-nos sobre sua necessidade..." className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"></textarea></div>
                          <button className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20">Enviar Mensagem</button>
                      </form>
                  </Reveal>
              </div>
          </Container>
      ...
      <footer className="bg-[#0f172a] text-slate-300 pt-20 pb-10">
        <Container>
            <div className="grid md:grid-cols-4 gap-12 mb-16">
                <div><div className="flex items-center gap-2 mb-6"><div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">AZ</div><span className="text-2xl font-bold text-white tracking-tight">Agro<span className="text-blue-500">Azul</span></span></div><p className="text-sm text-slate-400 mb-6">Especialistas em pulverização com drones para agricultura e controle urbano.</p><div className="flex gap-4"><a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors"><Facebook size={18}/></a><a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors"><Instagram size={18}/></a><a href="#" className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors"><Linkedin size={18}/></a></div></div>
                <div><h4 className="font-bold text-white mb-6">Serviços</h4><ul className="space-y-3 text-sm"><li><a href="#" className="hover:text-blue-400 transition-colors">Pulverização Agrícola</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Controle de Dengue</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Consultoria Técnica</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Orçamentos</a></li></ul></div>
                <div><h4 className="font-bold text-white mb-6">Empresa</h4><ul className="space-y-3 text-sm"><li><a href="#" className="hover:text-blue-400 transition-colors">Sobre Nós</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Equipe</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Certificações</a></li><li><button onClick={onNavigateToSystem} className="hover:text-blue-400 transition-colors flex items-center gap-1">IJA Drones <ArrowRight size={12}/></button></li></ul></div>
                <div><h4 className="font-bold text-white mb-6">Suporte</h4><ul className="space-y-3 text-sm"><li><a href="#" className="hover:text-blue-400 transition-colors">FAQ</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Área de Cobertura</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Contato</a></li><li><a href="#" className="hover:text-blue-400 transition-colors">Blog</a></li></ul></div>
            </div>
            <div className="border-t border-slate-800 pt-8 text-center text-xs text-slate-500">&copy; 2026 Agro Azul. Todos os direitos reservados.</div>
        </Container>
      </footer>
    </div>
  )
